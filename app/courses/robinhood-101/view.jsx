      ...
      <main className="min-h-screen bg-[#0a0a0f] text-white">
        ...
        <section className="relative overflow-hidden px-4 py-16">
          <div className="pointer-events-none absolute inset-0">
            <div className="absolute left-1/3 top-0 h-96 w-96 rounded-full bg-[#CCFF00]/10 blur-3xl" />
            <div className="absolute bottom-0 right-1/3 h-96 w-96 rounded-full bg-[#00A604]/10 blur-3xl" />
          </div>
          <div className="container relative z-10 mx-auto max-w-4xl text-center">
            <span className="mb-4 block text-6xl">🏹</span>
            <h1 className="mb-3 bg-gradient-to-r from-[#CCFF00] to-[#00A604] bg-clip-text text-4xl font-black text-transparent md:text-5xl">
              {ui.heroTitle}
            </h1>
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-3 text-sm">
              ...
              <span className="rounded-full border border-[#00A604]/40 bg-[#00A604]/15 px-3 py-1 text-[#00A604]">
                {ui.badgeDuration}
              </span>
