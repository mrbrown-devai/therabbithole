...
export const COURSES = [
  ...
  {
    slug: 'vlad-tenev',
    title: 'Vlad Tenev: The Man Who Made Trading Free',
    headline: 'Vlad Tenev — From Bulgaria to Robinhood to His Own Blockchain',
    description:
      'Free course on Vlad Tenev, co-founder and CEO of Robinhood. From Varna to Stanford, payment for order flow, the GameStop buy button and the 2021 hearing, through to Robinhood Chain — with a 10-question quiz.',
    ogSubtitle: 'The man who made trading free',
    emoji: '\u{1F3F9}',
    chapters: 7,
    minutes: 35,
    level: 'Beginner',
    ...
    keywords: [
      ...
      'Robinhood Chain',
      'HOOD stock',
      'fintech founder story',
      'Harmonic AI',
    ],
    teaches: [
      'Who Vlad Tenev is and how a Bulgarian immigrant family shaped his view of money',
      'How building trading software for HFT firms revealed the retail pricing gap',
      'What payment for order flow is and why free trading is never free',
      'What actually forced the GameStop trading restrictions in January 2021',
      'Why a brokerage ended up building its own Ethereum Layer 2',
    ],
    gradient: ['#00C805', '#CCFF00'],
  },
  {
    slug: 'robinhood-101',
    title: 'Robinhood 101: The Broker That Became a Blockchain',
    headline: 'Robinhood Chain 101 — Stock Tokens, Memecoins and How to Read the Chain',
    description:
      'Free course on Robinhood Chain: the Arbitrum Orbit L2, what Stock Tokens legally are, getting on-chain safely, the memecoin wave that took over, and how to read the on-chain numbers sceptically — with a 10-question quiz.',
    ogSubtitle: 'The broker that became a blockchain',
    emoji: '\u{1F3E6}',
    chapters: 10,
    minutes: 50,
    ...
    keywords: [
      ...
      'tokenized stocks',
      'chain ID 4663',
      'Robinhood Chain memecoins',
      'CASHCAT',
      'Noxa launchpad',
      'Robinhood L2',
    ],
    teaches: [
      'Why a brokerage built its own Ethereum Layer 2 after the GameStop clearing-house call',
      'What Robinhood Chain is technically — Arbitrum Orbit, chain ID 4663, ETH gas, no native token',
      'What a Stock Token legally is, and why economic exposure is not share ownership',
      'How to add the network, bridge and verify tokens without getting robbed',
      'Why memecoins can pair against tokenized Nvidia, and how that stacks five layers of risk',
      'How to read the chain’s TVL, fee and volume figures without being misled by them',
    ],
    gradient: ['#CCFF00', '#00A604'],
  },
  {
    slug: 'ton-history',
    title: 'TON History',
