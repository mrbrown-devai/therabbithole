...
export const TOKENS = {
  ...
  robinhoodDexVolume: usd(METRICS.robinhoodDexVolume?.value),
  robinhoodBridged: usd(METRICS.robinhoodBridged?.value),
  robinhoodAppFees: usd(METRICS.robinhoodAppFees?.value),
